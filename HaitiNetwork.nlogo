...
to setup-network
  ...
  ask nodes [
    ...
    set color white
    set water 0
    set demand fraction-kept-common
  ]
  ...
  create-elites 1 [
    ...
    set demand fraction-kept-elite
  ]
...
to flow-water
  ask turtles with [ water > 0 and given != 1 ] [
    ...
    ;; filters recipients into only those who do not have water yet
    set recipients recipients with [ water = 0 ]
    ...
    ask recipients [
        set water ( [ water ] of giver - ([ demand ] of giver * [ water ] of giver)) * ( nw:weighted-distance-to giver "weight" / [ total-weight ] of giver )
    ]

    ;; if have recipients to give it to who have met all the above criteria to be recipients, giver takes their demand fraction and "gives away" the rest
    if count recipients > 0 [
      set water demand * water
    ]

    ;; those who have already given water and kept their share do not give again
    set given 1
...
"" ""
PENS
"poor" 1.0 0 -16777216 true "" "plot sum [ water ] of nodes"
"elite" 1.0 0 -1184463 true "" "plot sum [ water ] of elites"
"health center" 1.0 0 -2674135 true "" "plot sum [ water ] of centers"
"gangs" 1.0 0 -955883 true "" "plot sum [ water ] of gangs"
"distributors" 1.0 0 -13840069 true "" "plot sum [ water ] of distributors"
...
"" ""
PENS
"nodes" 1.0 0 -16777216 true "" "if any? nodes [ plot mean [ water ] of nodes ]"
"health centers" 1.0 0 -2674135 true "" "if any? centers [plot mean [ water ] of centers ]"
"gangs" 1.0 0 -955883 true "" "if any? gangs [ plot mean [ water ] of gangs ]"
"elite" 1.0 0 -1184463 true "" "if any? elites [ plot mean [ water ] of elites ]"
"distributors" 1.0 0 -13840069 true "" "if any? distributors [ plot mean [ water ] of distributors ]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "if any? nodes [ plot min [ water ] of nodes ]"
"pen-1" 1.0 0 -2674135 true "" "if any? nodes [ plot max [ water ] of nodes ]"
